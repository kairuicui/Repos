...
def single_rides(_inData, params):
    ...
    def utility_PT():
        ...
        if params.get("PT_price") is None or params.get("PT_beta") is None:
            ...
            return (params.PT_price * req.dist / 1000 + req.VoT * params.PT_beta * (req.ttrav / params.PT_speed) + params.ascpt)
...
def pairs(_inData, params, process=True, check=True, plot=False):
    ...
    def utility_pt_i():
        return (params.PT_price * r.dist_i / 1000 + \
            r.VoT_i * params.PT_beta * (r.ttrav_i / params.PT_speed) + params.ascpt) #+ 999999

    def utility_pt_j():
        return (params.PT_price * r.dist_j / 1000 + \
            r.VoT_j * params.PT_beta * (r.ttrav_j / params.PT_speed) + params.ascpt) #+ 999999
...
def evaluate_shareability(_inData, params, plot=False):
    ...
    plt.xlabel("services")
    plt.savefig("D:\\project\\boxplot.png")
    plt.show()
